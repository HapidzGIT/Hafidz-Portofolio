    ...
    <div>
      <section id="projects" className="pt-24 pb-20 bg-[#1f252d]">
        <div className="container">
          ...
          <div className="flex relative flex-wrap w-full px-4 justify-center gap-8" data-aos="fade-up" data-aos-duration="1000">
            {open && (
              <>
            ...
            <div className="mb-12 lg:w-1/3  max-w-md border border-primary shadow-primary rounded-md shadow" data-aos="fade-up" data-aos-duration="1000">
              ...
              <p className="font-extralight leading-relaxed tracking-[2px] px-2">I made this project as a final assignment from my school to create something useful for the school. Finally I creating this information system.</p>
              ...
              <div className="my-4 mx-3 mb-7">
                <button className="inline px-7 py-3 font-medium text-[1.1rem] rounded-md bg-cyan-600 hover:bg-primary" onClick={handleClick}>
                  Panduan
                </button>
            ...
            <div className="mb-12 lg:w-1/3 border max-w-md border-primary shadow-primary rounded-md shadow" data-aos="fade-up" data-aos-duration="1000">
              <div className="rounded-md overflow-hidden ">
            ...
            <div className="mb-12 lg:w-1/3 max-w-md border-primary shadow-primary rounded-md shadow" data-aos="fade-up" data-aos-duration="1000">
              <div className="rounded-md overflow-hidden ">
