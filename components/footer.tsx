          ...
          <div className="flex flex-wrap items-center justify-center border-slate-600 border-b-2 pb-10">
            ...
            <div className="w-full px-4 md:w-1/3 mt-10">
              ...
              <ul className="font-medium tracking-[2px] underline">
                ...
                <li>
                  <a href="https://dribbble.com/hafid_11" target="_blank">
                    Dribble
                  </a>
                </li>
                <li>
                  <a href="https://twitter.com/Muhamma28299736" target="_blank">
                    Twitter
                  </a>
                </li>
              </ul>
          ...
          <div className="pt-10 w-full">
            <div className="flex items-center justify-center gap-5">
              ...
              <a href="https://dribbble.com/hafid_11" target="_blank" className="border rounded-full border-abu w-9 h-9 flex items-center justify-center hover:bg-primary hover:border-slate-300 text-white ">
                <svg role="img" width="25" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
